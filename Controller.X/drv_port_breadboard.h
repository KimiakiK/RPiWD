...
#define DRV_PORT_SWITCH_2P_A    RA5
#define DRV_PORT_SWITCH_2P_B    RB3
#define DRV_PORT_SWITCH_2P_C    RB1
#define DRV_PORT_SWITCH_2P_D    RB0

// ジョイスティック入力割り当て
#define DRV_PORT_JOYSTICK_1P_H  2   // AN0
#define DRV_PORT_JOYSTICK_1P_V  3   // AN1
#define DRV_PORT_JOYSTICK_2P_H  1   // AN2
#define DRV_PORT_JOYSTICK_2P_V  0   // AN3
